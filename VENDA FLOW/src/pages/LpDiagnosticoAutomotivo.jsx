      ...
      <div className="relative max-w-4xl mx-auto px-4 py-12">
        {etapa === 1 && (
          <div className="space-y-8">
            <div className="text-center">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b9c61551ff5384acadf3/cba16d128_Logoautozidamotorsfundobranco.png"
        ...
        {etapa === 3 && (
          <div className="space-y-8">
            <div className="text-center">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b9c61551ff5384acadf3/3340f0a02_Brasomarrafon2verso.png"
                alt="Brasão"
