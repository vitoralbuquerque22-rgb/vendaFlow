...
export default function Acesso() {
  ...
  const handleLogin = (e) => {
    ...
    const empresaId = urlParams.get("empresaId");
    if (empresaId) {
      base44.auth.redirectToLogin(createPageUrl("ChooseEmpresa") + `?empresaId=${empresaId}`);
    } else {
      base44.auth.redirectToLogin(createPageUrl("AutoSelectEmpresa"));
    }
  };
          ...
          {!modoRedefinirSenha && !mostrarRecuperarSenha && (
            <motion.div variants={item}>
              ...
              <div className="flex justify-between items-center mt-6">
                ...
                <button
                  type="button"
                  onClick={() => base44.auth.redirectToLogin(createPageUrl("CriarEmpresa"))}
                  style={{
                    fontSize: 14,
                    fontWeight: 600,
