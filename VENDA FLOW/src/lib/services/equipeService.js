...
const Equipes   = () => base44.entities.Equipe;
const Vinculos  = () => base44.entities.VinculoEmpresa;
const Produtos  = () => base44.entities.Produto;
const Formularios = () => base44.entities.Formulario;
...
export async function carregarMapaNomes(empresaId) {
  ...
  try {
    const profiles = await base44.entities.UserProfile.filter({ empresa_id: empresaId });
    const mapa = new Map();
