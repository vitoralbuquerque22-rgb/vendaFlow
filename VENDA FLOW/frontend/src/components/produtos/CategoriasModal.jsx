...
export default function CategoriasModal({ open, onClose }) {
  ...
  const { data: categorias = [] } = useQuery({
    ...
    queryFn: () => api.entities.CategoriaProduto.list(),
  });

  const criarMutation = useMutation({
    mutationFn: (data) => api.entities.CategoriaProduto.create(data),
    onSuccess: () => {
  ...
  const atualizarMutation = useMutation({
    mutationFn: ({ id, data }) => api.entities.CategoriaProduto.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["categorias-produto"] });
  ...
  const deletarMutation = useMutation({
    mutationFn: (id) => api.entities.CategoriaProduto.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["categorias-produto"] });
