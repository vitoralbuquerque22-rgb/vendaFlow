...
export default function DadosEmpresa() {
  ...
  const { data: empresaAtual, isLoading: loadingEmpresa } = useQuery({
    ...
    queryFn: async () => {
      ...
      const empresas = await api.entities.Empresa.filter({ id: empresaId });
  ...
  const criarEmpresaMutation = useMutation({
    mutationFn: async (dados) => {
      ...
      await api.auth.updateMe({ empresaAtualId: empresa.id });
      return empresa;
    },
    onSuccess: () => {
  ...
  const atualizarEmpresaMutation = useMutation({
    mutationFn: (data) => api.entities.Empresa.update(empresaId, data),
    onSuccess: () => {
