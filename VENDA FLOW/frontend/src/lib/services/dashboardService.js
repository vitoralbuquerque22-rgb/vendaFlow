...
const CommercialInsights  = () => api.entities.CommercialInsights;
const SdrDailyStats       = () => api.entities.SdrDailyStats;
const ConfiguracaoMetas   = () => api.entities.ConfiguracaoMeta;
const MonitoramentoLogs   = () => api.entities.MonitoramentoLog;
const RelatoriosPerf      = () => api.entities.RelatorioPerformance;
const LogsAcesso          = () => api.entities.LogAcesso;
const FaturamentoLeads    = () => api.entities.FaturamentoLead;
