...
export const config = {
  ...
  // Endereço que as funções usam para chamar a própria API
  internalApiUrl: env("INTERNAL_API_URL", `http://127.0.0.1:${port}`),

  entitiesDir: env("ENTITIES_DIR", "../base44/entities"),
  functionsDir: env("FUNCTIONS_DIR", "../base44/functions"),
  agentsDir: env("AGENTS_DIR", "../base44/agents"),
