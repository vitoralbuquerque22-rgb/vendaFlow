// Login, cadastro, tokens e usuários.
...
// Formato que o frontend espera: campos personalizados ficam na raiz do objeto
...
const USER_COLUMN_FIELDS = new Set(["id", "email", "role", "is_verified", "disabled", "created_date", "updated_date", "password_hash", "password"]);
