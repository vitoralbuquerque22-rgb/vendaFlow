// Integrações: IA (Claude), upload de arquivos e envio de e-mail.
...
// Lê o corpo como JSON ou multipart (quando há arquivo)
export async function readIntegrationBody(req: Request): Promise<Record<string, unknown>> {
...
export async function runIntegration(name: string, body: Record<string, unknown>, auth: AuthContext): Promise<unknown> {
